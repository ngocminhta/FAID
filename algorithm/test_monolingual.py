...
from utils.load_dataset import TextDataset, load_monolingual_dataset
...
def test_monolingual_3_labels(opt):
    ...
    test_database = load_monolingual_dataset(opt.test_dataset_path, language=opt.language)["test"]
